...
// import axios from 'axios'
// import handleHttpRequest from '../../services/httpHandler'
// export const FETCH_USER = "fetch_user";
// export const FETCH_ADMIN = "FETCH_ADMIN";
// export const FETCH_ADMIN_DATA = "FETCH_ADMIN_DATA";
// export const LOGOUT = "LOGOUT"
...
// export const fetchUser = () => async(dispatch, getState, getApi, ) => {
//     const userData = await handleHttpRequest('get', {}, '/users', token)
//     if (userData) {
//         dispatch({
//             type: FETCH_USER,
//             data: userData
...
// export const fetchAdminData = () => async(dispatch, getState, getApi) => {
//     const adminData = handleHttpRequest('get', {}, '/photos', token)
//     if (adminData) {
//         dispatch({
//             type: FETCH_ADMIN,
//             data: adminData.data
